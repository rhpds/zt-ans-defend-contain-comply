...
. In AAP Controller, navigate to **Automation Execution → Templates**.
...
----
. In AAP Controller, go back to **Automation Execution → Jobs** and click on the completed **Policy-Gated Patching** workflow job. Click on the **Pre-Patch Check**
+
On the job details look at the **Extra Vars** panel. The `set_stats` data from each job shows the complete audit trail:
+
