...
image::sec2.png[Splunk Search & Reporting]
...
image::sec4.png[Vulnerability Containment Workflow]
...
+
Lastly, navigate back to **Automation Decisions → Event Streams** and disable event forwarding.
